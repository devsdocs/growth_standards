...
_$WHOGrowthStandardsArmCircumferenceForAgeFromJson(Map<String, dynamic> json) =>
    _WHOGrowthStandardsArmCircumferenceForAge(
...
) => <String, dynamic>{'value': instance.value, 'age': instance.age.toJson()};
...
_$WHOGrowthStandardsBodyMassIndexForAgeFromJson(Map<String, dynamic> json) =>
    _WHOGrowthStandardsBodyMassIndexForAge(
      ...
      bodyMassIndexMeasurement:
          const WHOGrowthStandardsBodyMassIndexMeasurementConverter().fromJson(
...
Map<String, dynamic> _$WHOGrowthStandardsBodyMassIndexForAgeToJson(
  ...
  'bodyMassIndexMeasurement':
      const WHOGrowthStandardsBodyMassIndexMeasurementConverter().toJson(
        instance.bodyMassIndexMeasurement,
      ),
};
...
_$WHOGrowthStandardsHeadCircumferenceVelocityForAgeFromJson(
  ...
  pastMeasurement: (json['pastMeasurement'] as List<dynamic>)
      .map((e) => LengthMeasurementHistory.fromJson(e as Map<String, dynamic>))
      .toList(),
);
...
Map<String, dynamic> _$WHOGrowthStandardsHeadCircumferenceVelocityForAgeToJson(
  ...
  'sex': _$SexEnumMap[instance.sex]!,
  'age': instance.age.toJson(),
  'pastMeasurement': instance.pastMeasurement.map((e) => e.toJson()).toList(),
};
...
_$WHOGrowthStandardsLengthVelocityForAgeFromJson(Map<String, dynamic> json) =>
    _WHOGrowthStandardsLengthVelocityForAge(
      sex: $enumDecode(_$SexEnumMap, json['sex']),
      age: Age.fromJson(json['age'] as Map<String, dynamic>),
      pastMeasurement: (json['pastMeasurement'] as List<dynamic>)
          .map(
            (e) => LengthMeasurementHistory.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
    );
...
_$WHOGrowthStandardsTricepsSkinfoldForAgeFromJson(Map<String, dynamic> json) =>
    _WHOGrowthStandardsTricepsSkinfoldForAge(
      sex: $enumDecode(_$SexEnumMap, json['sex']),
      age: Age.fromJson(json['age'] as Map<String, dynamic>),
      measurementResult: Length.fromJson(
...
_$WHOGrowthStandardsWeightVelocityForAgeFromJson(Map<String, dynamic> json) =>
    _WHOGrowthStandardsWeightVelocityForAge(
      sex: $enumDecode(_$SexEnumMap, json['sex']),
      age: Age.fromJson(json['age'] as Map<String, dynamic>),
      pastMeasurement: (json['pastMeasurement'] as List<dynamic>)
          .map(
            (e) => MassMeasurementHistory.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
    );
