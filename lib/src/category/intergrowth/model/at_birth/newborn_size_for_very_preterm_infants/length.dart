...
class IntergrowthVeryPretermNewbornBirthLengthForAgeData extends AgeBasedData {
  ...
  _parse() => {
    Sex.male: _grow_verypreterm_boys_lt.toJsonObjectAsMap.map((k1, v1) {
      v1 as Map<String, dynamic>;
      final lms = LMS(l: v1['l'] as num, m: v1['m'] as num, s: v1['s'] as num);
      return MapEntry(
        int.parse(k1),
        _IntergrowthVeryPretermNewbornBirthLengthForAgeLMS(lms: lms),
      );
    }),
    Sex.female: _grow_verypreterm_girls_lt.toJsonObjectAsMap.map((k1, v1) {
      v1 as Map<String, dynamic>;
      final lms = LMS(l: v1['l'] as num, m: v1['m'] as num, s: v1['s'] as num);
      return MapEntry(
        int.parse(k1),
...
class _IntergrowthVeryPretermNewbornBirthLengthForAgeLMS extends LMSContext {
  _IntergrowthVeryPretermNewbornBirthLengthForAgeLMS({required this.lms});
  @override
  final LMS lms;
