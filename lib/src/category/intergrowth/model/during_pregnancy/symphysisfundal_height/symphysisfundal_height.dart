...
class IntergrowthSymphysisFundalHeightForAgeData extends AgeBasedData {
  ...
  static final _singleton = IntergrowthSymphysisFundalHeightForAgeData._(
    _parse(),
  );

  static Map<Sex, Map<num, _IntergrowthSymphysisFundalHeightForAgeLMS>>
  _parse() {
    final map = _sfhcore_16to41.map((k1, v1) {
      final lms = LMS(
        l: v1['l']! as num,
        m: v1['m']! as num,
        s: v1['s']! as num,
      );
      return MapEntry(k1, _IntergrowthSymphysisFundalHeightForAgeLMS(lms: lms));
    });
...
sealed class IntergrowthSymphysisFundalHeightForAge extends AgeBasedResult
  ...
  _IntergrowthSymphysisFundalHeightForAgeLMS get _ageData =>
...
class _IntergrowthSymphysisFundalHeightForAgeLMS extends LMSContext {
  _IntergrowthSymphysisFundalHeightForAgeLMS({required this.lms});
  @override
  final LMS lms;
