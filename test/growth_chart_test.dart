...
// void main() {
//   final armCirData = gs.armCircumferenceForAgeData; // Initialize for the first and only time to avoid repeated parsing the same data
...
//         equals(
//           male
//               .copyWithNull(observationDate: null)
...
//       final bmi = gs.bodyMassIndexForAge.bodyMassIndexMeasurement.fromValue(
//         20.5,
//         age: age,
//       );
//       final male = gs.bodyMassIndexForAge.male(
